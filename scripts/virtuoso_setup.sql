...
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('cello', 'https://www.mix-id1.cellosaurus.org/rdf/ontology/');
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('cvcl', 'https://www.mix-id1.cellosaurus.org/rdf/cvcl/');
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('xref', 'https://www.mix-id1.cellosaurus.org/rdf/xref/');
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('pub', 'https://www.mix-id1.cellosaurus.org/rdf/pub/');
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('orga', 'https://www.mix-id1.cellosaurus.org/rdf/orga/');
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('db', 'https://www.mix-id1.cellosaurus.org/rdf/db/');
...
insert into DB.DBA.SYS_XML_PERSISTENT_NS_DECL values ('help', 'https://test-api.cellosaurus.org/');
