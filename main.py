...
async def custom_swagger_ui_html(request: Request):
    ...
    tree = html.fromstring(html_response.body.decode())
    body_node = tree.xpath('//body')[0]
    nav = html.Element("nav")
    nav.text = "Hello friend !"
    body_node.insert(0,nav)
    final_html = html.tostring(tree, pretty_print=True, method="html", encoding="utf-8")
